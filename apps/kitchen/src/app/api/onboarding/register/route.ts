import { buildAgentKitchenMcpConfig, verifyAgentOnboardingToken } from "@/lib/agent-onboarding";
...
export async function POST(request: Request) {
  ...
  return Response.json({
    ok: true,
    ...result,
    mcp: buildAgentKitchenMcpConfig(verified.payload.mcpUrl),
    env: {
      KITCHEN_URL: verified.payload.kitchenUrl,
      KITCHEN_AGENT_ID: result.agent.id,
    },
