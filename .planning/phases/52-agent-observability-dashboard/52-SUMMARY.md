...
- Added `apps/kitchen/src/lib/agent-runtime/observability.ts`.
...
- `npm --prefix apps/kitchen run test -- src/app/api/agent-runtime/observability/__tests__/route.test.ts` passed.
